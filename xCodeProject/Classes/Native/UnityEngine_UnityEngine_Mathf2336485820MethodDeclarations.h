...
extern "C"  float Mathf_SmoothDampAngle_m935764888 (Il2CppObject * __this /* static, unused */, float ___current0, float ___target1, float* ___currentVelocity2, float ___smoothTime3, const MethodInfo* method) IL2CPP_METHOD_ATTR;
